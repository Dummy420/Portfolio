...
if ( ! class_exists( 'Portfolio_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Twenty Twenty-One 1.0
	 */
	class Portfolio_Customize {
		...
		public function register( $wp_customize ) {
			...
			include_once get_theme_file_path( 'classes/class-portfolio-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Portfolio_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Portfolio_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
